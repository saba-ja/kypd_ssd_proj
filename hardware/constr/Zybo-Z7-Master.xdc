...
##Switches
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { sw_level_select }]; #IO_L19N_T3_VREF_35 Sch=sw[0]
...
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { capture }]; #IO_L24N_T3_34 Sch=btn[1]
set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS33 } [get_ports {show_hidden_num }]; #IO_L10P_T1_AD11P_35 Sch=btn[2]
